...
def checkAutoSave(caseName="Default"):
    ...
    if os.path.exists(_autoSaveDirectory(caseName)):
        ...
        reloadAutoSaveDialog = qt.QMessageBox(qt.QMessageBox.Information, "Reload autosave?", "An autosave has been found, would you like to reload it?", qt.QMessageBox.Yes | qt.QMessageBox.Discard)
