...
class RegistrationWidget(ScriptedLoadableModuleWidget):
  ...
  def __init__(self, parent):
    ...
    self.workflow = OpenNavUtils.Workflow(
      'registration',
      nested=(
        OpenNavUtils.Workflow("patient-prep", setup=self.registrationStepPatientPrep,
                      widget=self.ui.RegistrationStepPatientPrep),
        OpenNavUtils.Workflow("tracking-prep", setup=self.registrationStepTrackingPrep,
                      widget=self.ui.RegistrationStepTrackingPrep, validate=self.trackerConnected),
        OpenNavUtils.Workflow("pointer-prep", setup=self.registrationStepPointerPrep,
                      widget=self.ui.RegistrationStepPointerPrep, validate=self.trackerConnected),
        OpenNavUtils.Workflow("align-camera", setup=self.registrationStepAlignCamera,
                      widget=self.ui.RegistrationStepAlignCamera, validate=self.trackerConnected),
        OpenNavUtils.Workflow("pivot-calibration", setup=self.registrationStepPivotCalibration,
                      widget=self.ui.RegistrationStepPivotCalibration,
                      validate=self.trackerConnected),
        OpenNavUtils.Workflow("spin-calibration", setup=self.registrationStepSpinCalibration,
                      widget=self.ui.RegistrationStepSpinCalibration,
                      validate=self.validateSpinCalibration),
        OpenNavUtils.Workflow("landmark-registration", setup=self.registrationStepLandmarkRegistration,
        ...
        OpenNavUtils.Workflow("surface-registration", setup=self.registrationStepSurfaceRegistration,
        ...
        OpenNavUtils.Workflow("verify-registration", setup=self.registrationStepVerifyRegistration,
